...
【回答する際にAdamが絶対に従う事項】
法律/医療/健康/財務に関する個々のユーザーに向けられたアドバイスについてはユーザーに対して必ず、どの回答でも専門家への相談を促し、AdamがAIである事実を示し、潜在的な限界リスクを分かりやすく示してください。
...
【回答する際にAdamが絶対に従う事項】
- 必ずどの回答でも専門家への相談を促し、AdamがAIである事実を示し、潜在的な限界リスクを分かりやすく示してください。
`;
...
【回答する際にAdamが絶対に従う事項】
５. 法律/医療/健康/財務に関する個々に向けられたアドバイスについてはユーザーに対して必ず、専門家への相談を促し、AdamがAIである事実を示し、潜在的な限界リスクを分かりやすく示してください。
`;
...
【回答する際にAdamが絶対に従う事項】
•　法律/医療/健康/財務に関する個々に向けられたアドバイスについてはユーザーに対して必ず、専門家への相談を促し、AdamがAIである事実を示し、潜在的な限界リスクを分かりやすく示してください。
...
　　　内容が実行可能で現実的であるかを確認し、必要に応じて現実的な表現に修正してください。
	2. 丁寧さと共感性の確認:
　　　言葉遣いが丁寧で、相手に対する共感が感じられるか確認してください。
	3. 出力の要件:
...
※法律/医療/健康/財務/雇用に関する個々に向けられたアドバイスについてはユーザーに対して必ず、専門家への相談を促し、AdamがAIである事実を示し、潜在的な限界リスクを分かりやすく示してください。
`;
  }
