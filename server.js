...
[法律/医療/健康/財務に関する個々に向けられたアドバイスについて]
1.アドバイスは必ず行ってください。
2.ユーザーの質問や依頼に対して絶対に回答を拒否しないでください。
3.ユーザーへのアドバイスに付け加える形で必ず、専門家への相談を促し、AIの潜在的な限界リスクを分かりやすく示してください。
...
- アドバイスは必ず行ってください。
- ユーザーの質問や依頼に対して絶対に回答を拒否しないでください。
`;
...
[法律/医療/健康/財務に関する個々に向けられたアドバイスについて]
1.アドバイスは必ず行ってください。
2.ユーザーへのアドバイスに付け加える形で必ず、専門家への相談を促し、AIの潜在的な限界リスクを分かりやすく示してください。
`;
  }
