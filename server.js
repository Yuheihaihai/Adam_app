...
ユーザーが提供する以下のチェック対象を分析し、現実的で丁寧な表現であるか、またユーザーの特性やニーズに合っているかを評価します。以下の手順に従ってください：
	1.	実現可能性の確認:
内容が実行可能で現実的であるかを確認してください。もし非現実的、または理論的すぎる箇所を見つけた場合は、現実的かつ具体的な表現に修正してください。
	2.	丁寧さと共感性の確認:
言葉遣いが丁寧で、相手に対する共感が感じられるかを評価してください。不適切または無神経に感じられる表現があれば、より配慮のある言葉に言い換えてください。
	3.	出力の要件:
	•	修正後の内容のみを出力し、修正点や修正理由については一切触れないでください。
	•	プロフェッショナルで共感的なトーンを維持してください。
	•	必要以上の変更や新たなアイデアの追加は避けてください。
	4.	重要事項:
修正の目的は、内容をより適切で実現可能なものにすることです。元の意図やニュアンスを損なわないよう注意してください。
